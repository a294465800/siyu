...
<div class="ui breadcrumb">
  ...
  <div class="divider"> / </div>
  <a class="section" href="../project/auth.html?id=12">权限设置 - 15823910212</a>
  <div class="divider"> / </div>
  <div class="active section">录入权限 - 陈巧笑</div>
</div>
    ...
    <table class="ui celled structured table unstackable center aligned">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <div class="ui radio checkbox">
              <input type="radio" name="project_detail">
              <label>可全部查看</label>
            </div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <div class="ui radio checkbox">
              <input type="radio" name="project_list">
              <label>可全部查看</label>
            </div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <div class="ui radio checkbox">
              <input type="radio" name="project_edit">
              <label>有此权限</label>
            </div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <div class="ui radio checkbox">
              <input type="radio" name="budget_list">
              <label>可全部查看</label>
            </div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <div class="ui radio checkbox">
              <input type="radio" name="budget_edit">
              <label>所有项目有权限</label>
            </div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <div class="ui radio checkbox">
              <input type="radio" name="check_tip">
              <label>有此权限</label>
            </div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <div class="ui radio checkbox">
              <input type="radio" name="check_operate">
        ...
        <tr>
          ...
          <td>
            <div class="ui radio checkbox">
              <input type="radio" name="check_tip_eidt_margins">
              <label>所有项目有权限</label>
            </div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <div class="ui radio checkbox">
              <input type="radio" name="check_tip_eidt_money">
              <label>所有项目有权限</label>
            </div>
          </td>
        </tr>
