...
<input type="hidden" id="invoiceName" value="专用票">
<input type="hidden" id="invoiceRate" value="11">
    ...
    <div class="ui three column doubling stackable grid">
      ...
      <div class="column">
        <div class="inline fields">
          ...
          <div class="eleven wide field">
            <input type="number" v-model.number="invoiceForm.rate" placeholder="请输入税率">
          </div>
        </div>
      </div>
      <div class="column"> 
        <div class="inline fields">
          ...
          <div class="eleven wide field">
            <input type="hidden" id="invoiceRemark" value="这是一些备注">
