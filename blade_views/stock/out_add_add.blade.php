...
<div class="invisible" id="outAddAdd">
      ...
      <div class="ui three column doubling stackable grid">
        ...
        <div class="column">
          <div class="inline fields">
            ...
            <div class="twelve wide field">
              <div class="fake-input">{{ current.material.material.parameter || '暂无'}}</div>
            </div>
          </div>
        </div>
        <div class="column">
        ...
        <div class="column">
          <div class="inline fields">
            ...
            <div class="twelve wide field">
              <div class="fake-input">{{ current.material.material.manufacturer || '暂无'}}</div>
            </div>
          </div>
        </div>
        <div class="column">
  ...
  <div class="ui form form-item">
    ...
    <transition-group name="slide-down" tag="div" class="form-wrap special-form">
      <div class="ui column doubling stackable grid center aligned" v-for="(item, index) in stockOutAdd.list" :key="item.id">
        ...
        <div class="two wide column">
          <div class="fake-input">{{ item.material && item.material.buy_count.toLocaleString('en-US') || 0}}</div>
        </div>
        <div class="two wide column">
          <div class="fake-input">{{ item.material && item.material.buy_amount.toLocaleString('en-US') || 0}} ￥</div>
        </div>
        <div class="two wide column">
          <input type="number" v-model="item.count" placeholder="出货数量">
        </div>
...
<include src="../template/footer.html">
  @js = ../../src/js/stock_out_add_add.js
</include>