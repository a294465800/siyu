    ...
    <div class="ui three column doubling stackable grid">
      ...
      <div class="column">
        <div class="inline fields">
          ...
          <div class="eleven wide field">
            ...
            <el-select v-model="addForm.bank" placeholder="请选择银行账号">
      ...
      <div class="column">
        <div class="inline fields">
          ...
          <div class="eleven wide field">
            <input type="number" v-model.number="addForm.account" placeholder="请输入收款账号">
          </div>
        </div>
      </div>
      <div class="column">
        <div class="inline fields">
          ...
          <div class="eleven wide field">
            <input type="text" v-model="addForm.payment" placeholder="请输入付款经办人">
          </div>
        </div>
      </div>
      <div class="column">
