...
<table class="ui celled structured table" id="budgetaryPrint">
  <thead>
    <tr>
      ...
      <th>采购金额</th>
      <th class="font-normal bg-white" colspan="7">123,421,421 ￥</th>
    </tr>
    <tr>
      <th>项目编号</th>
      ...
      <th>供货商</th>
      <th class="font-normal bg-white" colspan="7">xxx供货商</th>
    </tr>
    <tr>
      <th>发票条件</th>
      <th class="font-normal bg-white" colspan="6">专用票17%</th>
      <th>付款条件</th>
      <th class="font-normal bg-white" colspan="7">这是付款条件XXXx</th>
    </tr>
    <tr>
