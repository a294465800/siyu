...
<div id="loanSubmitOther">
    ...
    <div class="ui three column doubling stackable grid">
      <div class="column">
        <div class="inline fields">
          ...
          <div class="eleven wide field">
            <input type="text" v-model="submitProjectForm.people" placeholder="请输入报销人">
          </div>
        </div>
      </div>
      <div class="column">
      ...
      <div class="column">
        <div class="inline fields">
          ...
          <div class="eleven wide field">
            <input type="number" v-model.number="submitProjectForm.amount" placeholder="请选择报销金额">
          </div>
        </div>
      </div>
      <div class="column">
          ...
          <div class="eleven wide field">
            <el-autocomplete popper-class="my-autocomplete" v-model="submitProjectForm.project_id" :fetch-suggestions="querySearchProjectId"
              ...
              <template slot-scope="props">
                ...
                <span class="addr">{{ props.item.content }}</span>
              </template>
            </el-autocomplete>
          </div>
        </div>
  ...
  <div class="ui form form-item">
    ...
    <transition-group name="slide-down" tag="div" class="form-wrap special-form">
      <div class="ui column doubling stackable grid center aligned" v-for="(item, index) in submitProjectForm.list" :key="item.id">
...
<include src="../template/footer.html">
  @js = ../../src/js/loan_submit_project.js
</include>